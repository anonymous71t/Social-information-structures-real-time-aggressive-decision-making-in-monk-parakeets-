...
#write.csv(masterframe_retaliation.df_time_2021,"retal2021timemaster.csv", row.names = FALSE)
...
#masterframe_retaliation.df_time_2021 <- read_csv("retal2021timemaster.csv")
...
#write.csv(masterframe_retaliation.df, "retal2021countmaster_rule_spec_95perc.csv", row.names = FALSE)
```
...
```{r}
#masterframe_retaliation.df <- read_csv("retal2021countmaster_rule_spec_95perc.csv")
