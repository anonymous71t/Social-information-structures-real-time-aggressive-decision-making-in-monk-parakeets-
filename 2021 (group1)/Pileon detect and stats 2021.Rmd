...
#write.csv(masterframe_pileon.df_time_2021,"pile2021timemaster.csv", row.names = FALSE)
...
#masterframe_pileon.df_time_2021 <- read_csv("pile2021timemaster.csv")
#raw data 
...
#write.csv(masterframe_pileon.df,"pileon2021countmaster_rule_spec_95perc.csv", row.names = FALSE)
...
```{r}
#masterframe_pileon.df <- read_csv("pileon2021countmaster_rule_spec_95perc.csv")
